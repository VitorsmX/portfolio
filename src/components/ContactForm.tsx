  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Vou lhe retornar assim que possível.",
        variant: "default",
      ...
      toast({
        title: "Error",
        description: "Algo deu errado! favor checar campos preenchidos.",
        className: cn(
  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <Textarea
          placeholder="Me fale sobre o seu projeto ou proposta,"
          id="content"
          required
          value={message}
      ...
      >
        {loading ? (
          ...
          <div className="flex items-center justify-center">
            Mandar Mensagem <ChevronRight className="w-4 h-4 ml-4" />
          </div>
        )}
        <BottomGradient />
      </Button>
