import { EXPERIENCE, Skill, SkillNames, SKILLS } from "@/data/constants";
    ...
    >
      <div className="w-full max-w-4xl px-4 md:px-8 mx-auto">
        <SectionHeader
          ...
          desc="Minha jornada profissional."
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            {experience.skills.map((skillName) => {
              const skill = SKILLS[skillName as SkillNames] ?? (fallbackSkill || {icon: "", label: ""});
              return (
                <Badge
                  key={skillName}
                  variant="outline"
